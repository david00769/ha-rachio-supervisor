...
- the dashboard card is a packaged Home Assistant resource, not pasted inline
  ...
  as `/rachio_supervisor/rachio-supervisor-zone-grid-card.js?v=0.2.11` so
...
- URL: `/rachio_supervisor/rachio-supervisor-zone-grid-card.js?v=0.2.11`
...
5. Call `rachio_supervisor.evaluate_now` once. This forces fresh Rachio
   ...
   `/rachio_supervisor/rachio-supervisor-zone-grid-card.js?v=0.2.11` or a newer
...
Use `v0.2.11` or newer for HACS installs. That build includes the production
